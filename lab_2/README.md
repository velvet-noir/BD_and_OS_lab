...
- `top` - стандартная утилита для мониторинга процессов в реальном времени. Показывает время работы системы, среднюю нагрузку за период времени, нагрузку на CPU, количество RAM. Также отображается список процессов, 

![img](../assets/lab_2_image/image_11.png)

- `htop` - улучшенный `top`, с возможностью интерактивного взаимодейсвия. 

![img](../assets/lab_2_image/image_12.png)

- `iotop` - утилита для мониторинга нагрузки на диск в реальном времени. Отображает скорость чтения/записи для каждого процесса.

![img](../assets/lab_2_image/image_13.png)

### 7. Мониторинг PostgreSQL

- `pg_stat_activity` - системное представление в PostgreSQL, предоставляющее информацию в реальном времени обо всех активных соединениях и процессах базы данных.

Отображение только активных подключений:

![img](../assets/lab_2_image/image_14.png)

Отображение долгих процессов:

![img](../assets/lab_2_image/image_15.png)

- `pg_stat_database` - системное представление (view) в PostgreSQL, содержащее накопленную статистику по каждой базе данных. Отображает количество подключений, транзакций, сколько и какие операции происходили со строками в таблицах БД.

![img](../assets/lab_2_image/image_16.png)


- Принудительное завершение процесса:

![img](../assets/lab_2_image/image_17.png)

```SQL
SELECT pg_terminate_backend(2260);
```
